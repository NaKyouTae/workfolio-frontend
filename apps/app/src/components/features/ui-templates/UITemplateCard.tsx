...
import { UITemplate, getUITemplateTypeLabel, formatDuration } from '@workfolio/shared/types/uitemplate';
import {
...
} from '@/components/features/public-resume/templates/resumeTemplateConfig';
