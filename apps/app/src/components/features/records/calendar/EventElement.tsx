...
import { CalendarEvent, EventElementProps } from '@workfolio/shared/models/CalendarTypes'
import styles from '@workfolio/shared/styles/MonthlyCalendarV2.module.css'
