        ...
        <div className="page-cont">
            <article>
                ...
                <div className="cont-box" id="privacy-1">
                    ...
                    <div className="terms-desc">
                        <p>회사는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 개인정보보호법 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.<br/><br/>
                        ...
                        2. 재화 또는 서비스 제공<br/>
                        서비스 제공, 콘텐츠 제공, 맞춤서비스 제공, 본인인증, 연령인증, 요금 결제 및 정산, 채권추심 등을 목적으로 개인정보를 처리합니다.<br/><br/>
                        3. 고충 처리<br/>
                ...
                <div className="cont-box" id="privacy-4">
                    ...
                    <div className="terms-desc">
                        <p>회사는 다음의 개인정보 항목을 처리하고 있습니다.<br/><br/>
                        1. 홈페이지 회원 가입 및 관리<br/>
                        필수항목 : 닉네임<br/>
                ...
                <div className="cont-box" id="privacy-7">
                    ...
                    <div className="terms-desc">
                        ...
                        ③ 정보주체는 웹 브라우저 옵션 설정을 통해 쿠키 허용, 차단 등의 설정을 할 수 있습니다. 다만, 쿠키 저장을 거부할 경우 맞춤형 서비스 이용에 어려움이 발생할 수 있습니다.<br/><br/>
                ...
                <div className="cont-box" id="privacy-8">
                    ...
                    <div className="terms-desc">
                        <p>① 회사는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만 처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.<br/><br/>
                        ▶ 개인정보 보호책임자<br/>
                        성명 : 나규태<br/>
                        직책 : 대표<br/>
                        연락처 : 01091092682, kyoutae_93@naver.com<br/>
                        ※ 개인정보 보호 담당부서로 연결됩니다.<br/><br/>
                        ▶ 개인정보 보호 담당부서<br/>
                        부서명 : 스펙트럼 총괄팀<br/>
                        연락처 : 01091092682, kyoutae_93@naver.com<br/><br/>
                ...
                <div className="cont-box" id="privacy-10">
                    ...
                    <div className="terms-desc">
                        <p>이 개인정보 처리방침은 202X. X. X. 부터 적용됩니다.</p>
                    </div>
                </div>
            </article>
            <FloatingNavigation
