...
// PUT /api/ui-templates/my/default/[uiTemplateId] - Set default UI template
export async function PUT(
    ...
    try {
        ...
        const res = await apiFetchHandler(
            `${API_BASE_URL}/api/ui-templates/my/default/${uiTemplateId}`,
            HttpMethod.PUT,
            undefined,
            accessToken
        );
        ...
        console.error('Error in PUT /api/ui-templates/my/default/[uiTemplateId]:', error);
