...
// GET /api/ui-templates/my/active - Get my active UI templates
export async function GET(request: NextRequest) {
    try {
        ...
        let url = `${API_BASE_URL}/api/ui-templates/my/active`;
        if (type) {
            url += `?type=${type}`;
        }
        ...
        console.error('Error in GET /api/ui-templates/my/active:', error);
