  ...
  fromJSON(object: any): RecordGroupJoinRequest {
    return {
      ...
      newWorkers: globalThis.Array.isArray(object?.newWorkers)
        ...
        : globalThis.Array.isArray(object?.new_workers)
        ? object.new_workers.map((e: any) => RecordGroupJoinRequest_JoinWorkerRequest.fromJSON(e))
        : [],
      existWorkers: globalThis.Array.isArray(object?.existWorkers)
        ...
        : globalThis.Array.isArray(object?.exist_workers)
        ? object.exist_workers.map((e: any) => RecordGroupJoinRequest_JoinWorkerRequest.fromJSON(e))
        : [],
    };
  },
...
> = {
  ...
  fromJSON(object: any): WorkerRecordGroupPriorityUpdateRequest_PriorityItem {
    return {
      workerRecordGroupId: isSet(object.workerRecordGroupId)
        ? globalThis.String(object.workerRecordGroupId)
        : isSet(object.worker_record_group_id)
        ? globalThis.String(object.worker_record_group_id)
        : "",
      priority: isSet(object.priority) ? globalThis.Number(object.priority) : 0,
    };
  },
