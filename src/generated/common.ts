...
export function subscription_SubscriptionStatusFromJSON(object: any): Subscription_SubscriptionStatus {
  switch (object) {
    case 0:
    case "UNKNOWN":
      return Subscription_SubscriptionStatus.UNKNOWN;
    case 1:
    case "ACTIVE":
      return Subscription_SubscriptionStatus.ACTIVE;
    case 2:
    case "EXPIRED":
      return Subscription_SubscriptionStatus.EXPIRED;
    case 3:
    case "CANCELLED":
      return Subscription_SubscriptionStatus.CANCELLED;
    case -1:
    case "UNRECOGNIZED":
    default:
      return Subscription_SubscriptionStatus.UNRECOGNIZED;
  }
}

export function subscription_SubscriptionStatusToJSON(object: Subscription_SubscriptionStatus): string {
  switch (object) {
    case Subscription_SubscriptionStatus.UNKNOWN:
      return "UNKNOWN";
    case Subscription_SubscriptionStatus.ACTIVE:
      return "ACTIVE";
    case Subscription_SubscriptionStatus.EXPIRED:
      return "EXPIRED";
    case Subscription_SubscriptionStatus.CANCELLED:
      return "CANCELLED";
    case Subscription_SubscriptionStatus.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
function createBaseTurnOver(): TurnOver {
  return { id: "", name: "", worker: undefined, createdAt: 0, updatedAt: 0 };
}
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 50: {
          ...
          message.turnOverGoal = TurnOverGoal.decode(reader, reader.uint32());
          continue;
        }
        case 98: {
          if (tag !== 784) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 50: {
          ...
          message.turnOverChallenge = TurnOverChallenge.decode(reader, reader.uint32());
          continue;
        }
        case 98: {
          if (tag !== 784) {
...
function createBaseFeature(): Feature {
  return { id: "", name: "", domain: "", action: "", limit: 0, createdAt: 0, updatedAt: 0 };
}
...
function createBasePlanFeature(): PlanFeature {
  return { id: "", plan: undefined, feature: undefined, createdAt: 0, updatedAt: 0 };
}
