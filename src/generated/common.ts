...
export enum Degrees_DegreesStatus {
  UNKNOWN = 0,
  IN_PROGRESS = 1,
  GRADUATING = 2,
  GRADUATED = 3,
...
export function degrees_DegreesStatusFromJSON(object: any): Degrees_DegreesStatus {
  switch (object) {
    case 0:
    case "UNKNOWN":
      return Degrees_DegreesStatus.UNKNOWN;
    case 1:
    case "IN_PROGRESS":
      return Degrees_DegreesStatus.IN_PROGRESS;
    case 2:
    case "GRADUATING":
      return Degrees_DegreesStatus.GRADUATING;
    case 3:
    case "GRADUATED":
      return Degrees_DegreesStatus.GRADUATED;
    case -1:
    case "UNRECOGNIZED":
    default:
      return Degrees_DegreesStatus.UNRECOGNIZED;
  }
}

export function degrees_DegreesStatusToJSON(object: Degrees_DegreesStatus): string {
  switch (object) {
    case Degrees_DegreesStatus.UNKNOWN:
      return "UNKNOWN";
    case Degrees_DegreesStatus.IN_PROGRESS:
      return "IN_PROGRESS";
    case Degrees_DegreesStatus.GRADUATING:
      return "GRADUATING";
    case Degrees_DegreesStatus.GRADUATED:
      return "GRADUATED";
    case Degrees_DegreesStatus.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export const ResumeDetail: MessageFns<ResumeDetail> = {
  encode(message: ResumeDetail, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.worker !== undefined) {
      Worker.encode(message.worker, writer.uint32(18).fork()).join();
    }
    for (const v of message.careers) {
      Career.encode(v!, writer.uint32(26).fork()).join();
    }
    for (const v of message.degrees) {
      Degrees.encode(v!, writer.uint32(34).fork()).join();
    }
    for (const v of message.certifications) {
      Certifications.encode(v!, writer.uint32(42).fork()).join();
    }
    for (const v of message.educations) {
      Education.encode(v!, writer.uint32(50).fork()).join();
    }
    for (const v of message.links) {
      Link.encode(v!, writer.uint32(58).fork()).join();
    }
    return writer;
  },
...
function createBaseLink(): Link {
  return { id: "", url: "", isVisible: false, resume: undefined, createdAt: 0, updatedAt: 0 };
}
