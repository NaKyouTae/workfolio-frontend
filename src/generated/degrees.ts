...
import { Degrees, Degrees_DegreesStatus, degrees_DegreesStatusFromJSON, degrees_DegreesStatusToJSON } from "./common";
...
function createBaseDegreesCreateRequest(): DegreesCreateRequest {
  return { name: "", major: "", startedAt: 0, endedAt: undefined, status: 0, resumeId: "" };
}
...
function createBaseDegreesUpdateRequest(): DegreesUpdateRequest {
  return { id: "", name: "", major: "", startedAt: 0, endedAt: undefined, status: 0 };
}
